...
const DaysOfTheWeekBtns = props => {
  ...
  return (
    <React.Fragment>
      <Button btnAction={btnClick} type={"action"} title={"Mon"}>
        <span>Mon</span>
      </Button>
      <Button btnAction={btnClick} type={"action"} title={"Tue"}>
        <span>Tue</span>
      </Button>
      <Button btnAction={btnClick} type={"action"} title={"Wed"}>
        <span>Wed</span>
      </Button>
      <Button btnAction={btnClick} type={"action"} title={"Thu"}>
        <span>Thu</span>
      </Button>
      <Button btnAction={btnClick} type={"action"} title={"Fri"}>
        <span>Fri</span>
      </Button>
      <Button btnAction={btnClick} type={"action"} title={"Sat"}>
        <span>Sat</span>
      </Button>
      <Button btnAction={btnClick} type={"action"} title={"Sun"}>
        <span>Sun</span>
      </Button>
    </React.Fragment>
  );
